...
df1 = df[['companySize', 'salary', 'maxSalary', 'minSalary']]
...
avgSalarys = df1.groupby(['companySize'])['avg'].mean()
...
plt.xlabel(u'公司规模', fontproperties=custom_font)
...
plt.savefig("avg_salary_of_companySize.png", dpi=100)
